...
String _translatePhase(String raw) {
  ...
  // Free-text formats (from notes headline or event name)
  ...
  // Group stage: "Group A", "Grupo B", single letter "A"
  ...
  // Fallback: show as-is if it looks meaningful, else default to Fase de Grupos
